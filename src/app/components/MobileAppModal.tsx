...
export function MobileAppModal({ isOpen, onClose }: MobileAppModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-[500px] w-full p-8">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="flex justify-center mb-6">
          <div className="size-20 bg-red-50 dark:bg-red-900/20 rounded-full flex items-center justify-center">
            <AlertTriangle className="size-10 text-red-500" />
          </div>
        </div>

        {/* Message */}
        <p className="text-center text-gray-900 dark:text-white text-lg mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 bg-black hover:bg-gray-800 text-white rounded-xl px-6 py-3.5 transition-colors"
          >
