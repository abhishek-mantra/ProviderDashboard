...
function TextInput14() {
  return (
    <div className="absolute h-[21px] left-[7px] top-[23px] w-[272px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip px-[4px] py-[2px] relative rounded-[inherit] size-full">
...
function TextInput15() {
  return (
    <div className="absolute h-[21px] left-[7px] top-[46px] w-[272px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip px-[4px] py-[2px] relative rounded-[inherit] size-full">
...
function TextInput16() {
  return (
    <div className="col-1 justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[4px] py-[2px] relative size-full">
...
function TextInput17() {
  return (
    <div className="col-2 justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[4px] py-[2px] relative size-full">
...
function TextInput18() {
  return <div className="absolute border-[#d1d5dc] border-b border-solid h-[21px] left-[7px] top-[106px] w-[272px]" data-name="Text Input" />;
}
...
function TextInput29() {
  return <div className="absolute border-[#d1d5dc] border-b border-solid h-[21px] left-[7px] top-[23px] w-[272px]" data-name="Text Input" />;
}
...
function TextInput32() {
  return (
    <div className="col-3 justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[4px] py-[2px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(10,10,10,0.5)] whitespace-nowrap">YY</p>
        </div>
...
function TextInput33() {
  return <div className="absolute border-[#d1d5dc] border-b border-solid h-[21px] left-[7px] top-[154px] w-[272px]" data-name="Text Input" />;
}
...
function Option() {
  return <div className="absolute left-[-192px] size-0 top-[288.34px]" data-name="Option" />;
}
...
function Dropdown() {
  return (
    <div className="absolute border border-[#d1d5dc] border-solid h-[24px] left-[7px] top-[73px] w-[174px]" data-name="Dropdown">
      <Option />
      <Option1 />
    </div>
  );
...
function Option2() {
  return <div className="absolute left-[-388px] size-0 top-[300.34px]" data-name="Option" />;
}

function Dropdown1() {
  return (
    <div className="absolute border border-[#d1d5dc] border-solid h-[24px] left-[7px] top-[61px] w-[174px]" data-name="Dropdown">
      <Option2 />
    </div>
  );
}
...
function TextInput58() {
  return <div className="absolute border border-[#d1d5dc] border-solid h-[22px] left-[7px] top-[65px] w-[272px]" data-name="Text Input" />;
}
...
function Xc() {
  return (
    <div className="bg-[#f5f5f7] h-[2088.094px] relative shrink-0 w-full" data-name="Xc">
      <Container />
      <Container3 />
    </div>
  );
