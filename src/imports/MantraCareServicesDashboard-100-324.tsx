import svgPaths from "./svg-dcb4uaxr16";
...
function Heading11() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Heading 3">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#020817] text-[14px] text-center whitespace-nowrap">Dr. Michael Brown</p>
    </div>
  );
}
...
function Container36() {
  return (
    <div className="absolute content-stretch flex flex-col h-[36px] items-start left-[52px] top-[2px] w-[115.531px]" data-name="Container">
      <Heading11 />
      <Paragraph9 />
    </div>
  );
...
function Container35() {
  return (
    <div className="h-[40px] relative shrink-0 w-[167.531px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <Button10 />
      </div>
    </div>
...
function ImageWithFallback10() {
  return (
    <div className="relative rounded-[33554400px] shrink-0 size-[32px]" data-name="ImageWithFallback">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[33554400px] size-full" src={imgImageWithFallback1} />
    </div>
  );
}
